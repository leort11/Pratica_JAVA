...
public class OlaMundoJava extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblMensagem.setForeground(new java.awt.Color(0, 0, 102));
        lblMensagem.setText("Aqui vai apaecer a mensagem");

        btnClick.setForeground(new java.awt.Color(0, 0, 102));
